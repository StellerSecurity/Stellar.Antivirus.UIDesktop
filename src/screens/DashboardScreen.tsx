  ...
  return (
    <div className="h-full flex flex-col gap-6 pt-6">
      <div className="grid grid-cols-2 gap-6">
        ...
        {/* Full scan card */}
        <div className="bg-gradient-to-br from-[#2563EB] to-[#1D4ED8] rounded-[24px] px-6 py-6 text-white flex flex-col justify-between">
          <div>
            <div className="text-xs font-semibold opacity-80 mb-2">
              FULL DISK SCAN
            </div>
            <h2 className="text-[30px] font-semibold font-poppins mb-1">
          ...
          <div className="mt-6 flex items-center justify-between gap-4">
            <Button
              onClick={onFullScan}
              disabled={isScanning}
              className="flex-1 bg-white text-[#1D4ED8] hover:bg-white/90"
            >
      ...
      {isScanning && (
        <div className="bg-white rounded-[24px] px-6 py-5 flex items-center gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[11px] text-[#6B7280]">
                {scanProgress.total > 0
                  ? `Scanning files… ${progressDisplay}%`
                  : "Preparing scan…"}
              </span>
            </div>
            {currentFileDisplay && (
            ...
            {recentLogs.map((log) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  onClick={onOpenActivityLog}
                  className="w-full flex items-center justify-between text-xs py-2 rounded-2xl px-3 hover:bg-[#F3F4FF] cursor-pointer"
                >
